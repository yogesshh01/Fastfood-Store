...
function Cart({ cart, setCart }) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 pt-32">
        <div className="text-center animate-fade-in">
          ...
          <p className="text-gray-500 text-lg mb-1">Your food is being prepared.</p>
  ...
  if (cart.length === 0) {
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4 pt-32">
        <div className="text-center">
          ...
          <button
            ...
            className="bg-red-500 hover:bg-red-600 active:scale-95 text-white font-bold px-8 py-3 rounded-xl transition-all shadow-lg hover:shadow-red-200 text-base"
          >
            Browse Menu
          </button>
        </div>
    ...
    <div className="min-h-screen bg-gray-50 pt-32">
      ...
      <div className="bg-white border-b border-gray-100 sticky top-0 z-10 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 md:px-8 py-4 flex items-center justify-between">
          <button
            onClick={() => navigate("/menu")}
            className="flex items-center gap-2 text-gray-600 hover:text-red-500 font-semibold transition-colors cursor-pointer"
          >
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 flex flex-col gap-4">
          {cart.map((item) => (
            ...
            >
              {/* Image */}
              <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-xl overflow-hidden flex-shrink-0 bg-gray-50">
                <img
                  src={item.image}
                  alt={item.name}
              ...
              <div className="flex-1 flex flex-col justify-between min-w-0">
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0">
                    ...
                    <span className="text-xs text-gray-400 bg-gray-50 border border-gray-100 px-2 py-0.5 rounded-full inline-block mt-1">
                      {item.category}
                    </span>
                  </div>
                  <button
                ...
                <div className="flex items-center justify-between mt-3">
                  {/* Quantity Controls */}
                  <div className="flex items-center gap-3 bg-gray-50 border border-gray-100 rounded-xl px-3 py-1.5">
                    <button
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-24">
            ...
            <div className="mb-5">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500/20 disabled:opacity-60"
                />
                <button
                  onClick={handlePromo}
                  disabled={promoApplied}
            ...
            <button
              onClick={() => navigate("/menu")}
              className="mt-3 w-full border border-gray-200 hover:bg-gray-50 text-gray-600 font-semibold py-3 rounded-xl transition-all text-sm cursor-pointer"
            >
              Continue Shopping
            </button>
          </div>
